export const exercises = [
  {
    id: "01",
    title: "Times Table",
    descriptionEn: "Given a number, return its complete multiplication table from 1 to 10.",
    statementEn:
      'Given a number, write a function that returns its complete multiplication table from 1 to 10. The function should accept a single number as a parameter and output each multiplication line in the format "n x i = result".',
    statementEs:
      'Dado un número, escribe una función que devuelva su tabla de multiplicar completa del 1 al 10. La función debe aceptar un solo número como parámetro y devolver cada línea de multiplicación en el formato "n x i = resultado".',
    file: "js/exercises/01-times-table.js",
  },
  {
    id: "02",
  ...
  },
  {
    ...
    title: "Word Finder",
    descriptionEn:
      "Given a phrase and a word, count how many times the word appears in the phrase.",
    statementEn:
      "Given a phrase and a word, write a function that searches for the word within the phrase and returns how many times it appears. The comparison should be case-insensitive and ignore punctuation. Both the phrase and the word should be accepted as parameters.",
    statementEs:
      "Dada una frase y una palabra, escribe una función que busque la palabra dentro de la frase y devuelva cuántas veces aparece. La comparación debe ser sin distinguir mayúsculas/minúsculas y debe ignorar la puntuación. Tanto la frase como la palabra deben ser aceptadas como parámetros.",
    file: "js/exercises/03-word-finder.js",
  },
  {
    id: "04",
    title: "Palindrome",
